const questions = [
    ...
    {
        question: 'Khi một người chồng luôn ưu tiên bạn bè hơn gia đình, điều này có thể gây ra hậu quả gì cho mối quan hệ hôn nhân?',
        options: [
    ...
    {
        question: 'Bạn Nghĩ Gì Về chồng mình?',
        options: [
            'Bảo thủ.',
            'Thẳng tính.',
            'Cộc cằn.',
        ...
        correctAnswer: 'Thẳng tính.',
        feedback: {
            correct: 'Chính xác! Một người chồng thẳng thắn lý tưởng là người biết cách chỉ ra cái sai một cách xây dựng, tôn trọng cảm xúc của đối phương, và luôn tìm kiếm sự cân bằng.',
            incorrect: 'Sai rồi. Tính cách cũng góp 1 phần cho những mối quan hệ gia đình, đừng chê trách anh ấy.'
        }
    },
];
